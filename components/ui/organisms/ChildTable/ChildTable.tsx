...
export function ChildTable<T extends Record<string, unknown> = Record<string, unknown>>({
  ...
  return (
    <div className={cn('flex flex-col', className)}>
      ...
      <a
        href="#ct-grid-body"
        className="sr-only focus:not-sr-only focus:absolute focus:z-50 focus:bg-primary focus:text-primary-foreground focus:px-3 focus:py-1 focus:rounded focus:text-sm"
      >
      ...
      >
        ...
        >
          ...
          <div role="row" className="contents">
            ...
            <div
              role="columnheader"
              className="sticky left-0 z-20 flex items-center justify-center h-[50px] bg-muted border-b border-border"
            >
              {isSelectable && (
                <input
                  type="checkbox"
            ...
            return (
              ...
              >
                ...
                <div
                  role="gridcell"
                  className={cn(
                    'sticky left-0 z-10 relative h-[50px] border-b border-border transition-colors duration-200',
