  ...
  ({ className, error, autoGrow, ...props }, ref) => {
    ...
    return (
      <textarea
        ...
        className={cn(
          'w-full px-3 py-2 rounded border border-border text-sm transition-all duration-300 ease-in-out bg-background text-foreground min-h-[80px] resize-y focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ring',
