...
const categories = [
  ...
  },
  {
    ...
    title: 'Molecules',
    count: 47,
    description: 'Composed atoms forming reusable UI patterns for forms, data, overlays, and interactive inputs.',
    highlights: [
      'ContentHeader, DataTable, Card, Modal',
      'PageContent, ResponsiveGrid, CategoryGrid',
      'AddressInput, MentionInput, ActivityFeed',
      'DashboardWidget, Combobox (multi/async)',
    ],
  },
  {
    href: '/ui/organisms',
